...
// NewJSONStringQuery - Create a new &JQ from a raw JSON string.
func NewJSONStringQuery(jsonString string) (*JQ, error) {
	var data = new(interface{})
...
// NewJSONQuery - Create a &JQ from an interface{} parsed by json.Unmarshal
func NewJSONQuery(jsonObject interface{}) *JQ {
